...
//		this.rightLimit = rightLimit;
	...
	/**
	 * Cambia el límite derecho y actualiza los datos de la gráfica.
	 * En el caso de ser el nuevo límite derecho menor que el antiguo límite izquierdo, 
	 * modifica el límite izquierdo manteniendo la anchura del intervalo.
	...
	/**
	 * Cambia el límite izquierdo y actualiza los datos de la gráfica.
	 * En el caso de ser el nuevo límite izquierdo mayor que el antiguo límite derecho, 
	 * modifica el límite derecho manteniendo la anchura del intervalo.
...
//	}
	 ...
	 * @param leftLimit límite izquierdo
	 * @param rightLimit límite derecho
	 * @throws IllegalArgumentException si el límite izquierdo es superior al derecho
	 */
	public void setLimites(double leftLimit, double rightLimit) throws IllegalArgumentException {
		...
		else if(this.leftLimit!=leftLimit || this.rightLimit!=rightLimit) {	//si son iguales evitamos tener que actualizar los datos
			this.leftLimit = leftLimit;
			this.rightLimit = rightLimit;
			updateData();
		}
	...
	/**
	 * Añade una función a la gráfica.
	 * Si dicha función ya se encuentra en la gráfica, no será añadida.
	...
	public boolean add(Funcion funcion) {
		try {
			...
			System.out.println("Funcion ya añadida");
//			e.printStackTrace();
			return false;
		}
	}
